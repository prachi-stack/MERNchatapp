...
const LoginPage = () => {
  ...
  const { login, isLoggingIng } = useAuth();
  ...
  return (
    <div className="min-h-screen flex items-center justify-center p-6 sm:p-12 bg-base-200">
      <div className="w-full max-w-md">
        <div className="rounded-2xl border border-base-300 p-8 shadow-sm bg-base-100 space-y-8">
